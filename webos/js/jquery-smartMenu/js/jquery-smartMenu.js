...
//					if((e.currentTarget.id == "lr_bar" || e.currentTarget.id.indexOf("myWinTab_") != -1) && $("#program_item").css("display") == "none"){
					if(e.currentTarget.id == "lr_bar" && $("#program_item").css("display") == "none"){
						//回调
						if ($.isFunction(params.beforeShow)) {
							params.beforeShow.call(this);	
						}
