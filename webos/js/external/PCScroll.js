...
//	obj.scrollBarIndex.onmousewheel = scrollMove;
	...
	//拖动滚动条滚动
//	obj.scrollBarIndex.ontouchstart = function(evt){
//		alert("ontouchstart");
//		evt = evt || event;
//		scrollPageY = evt.clientY;
//		scrollY = this.scrollDiv.scrollTop;
...
function scrollResetSize(o) {
	...
	o.scrollBar.style.height = o.clientHeight - 8 + 'px';
	o.scrollBar.style.top = y + borderTop + 5 + 'px';
	o.scrollBar.style.left = x + o.offsetWidth - 175 - o.scrollBarWidth + 'px';
	...
	o.scrollBarHeight = h;
	o.scrollBarIndex.style.height = h - 10 + 'px';
...
//document.documentElement.ontouchmove = function(evt){
//
//	if(!scrollMoveObj)return;
//	alert("ontouchmove");
//	evt = evt || event;
...
//document.documentElement.ontouchend = function(evt){
//
//	if(!scrollMoveObj)return;
//	alert("ontouchend");
//	if(scrollMoveObj.scrollBar.className == '') {
